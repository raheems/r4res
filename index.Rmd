...
description: "A book on R software for data analysis for research in social and medical science"
---
...
Before you begin, I would like to point out that this book is being actively written. That means, the organization of the contents is not finalized. As such, bookmarks would not be stable at this point. I would adivse not to bookmark any chapter or section. Instead, bookmark the website of the book which is http://r4res.eraheem.com. More importantly, bookmark the Issue queue 
- https://github.com/raheems/r4res/issues. If you have any questions or suggestions or feature requests, you can submit a request there. 
...
Firstly, thank you for reading this book. I hope this will be beneficial for you. Skim throgh the book and take a look at the contents. If you see anything is missing or you want me to cover additional topics, please feel free to let me know by emailing to raheem at gmail dot com. You can also request features at the issue queue located at https://github.com/raheems/r4res/issues

You would need to have an account at Github.com, which is absolutely free. Just sign up and submit a request there. This way, I will be able to manage the feature requests as well provide updates in an organized way.
